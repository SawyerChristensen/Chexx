...
- [~] Research popular optimization techniques that other Chess Engines (such as stockfish use) and implement them here
  ...
  - [ ] Research and evaluate multi-threaded/parallel search feasibility for the minimax tree (e.g. splitting root moves across threads with a shared/synchronized transposition table); implement if feasible given Swift concurrency constraints
