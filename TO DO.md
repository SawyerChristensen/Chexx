...
- [~] Research popular optimization techniques that other Chess Engines (such as stockfish use) and implement them here
  ...
  - [ ] Add null-move pruning to minimax (skip a move to let the opponent move twice; if that still fails high, prune this branch), guarded against zugzwang-prone endgame positions
