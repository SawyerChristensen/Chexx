...
- [~] Research popular optimization techniques that other Chess Engines (such as stockfish use) and implement them here
  ...
  - [ ] Research SIMD/GPU offloading feasibility for move evaluation on this stack and document findings (likely not practical for a tree-search engine like this, but worth confirming)
